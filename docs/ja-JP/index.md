...
[![スポンサー AI API](https://raw.githubusercontent.com/BenedictKing/ccx-kit/main/src/assets/302.ai.jpg)](https://share.302.ai/gAT9VG)
...
[![GLM](https://raw.githubusercontent.com/BenedictKing/ccx-kit/main/src/assets/GLM-en.png)](https://z.ai/subscribe?ic=8JVLJQFSKB)
...
<td>PackyCode がこのプロジェクトをスポンサーしてくれたことに感謝します！PackyCode は信頼性が高く効率的な API リレーサービスプロバイダーで、Claude Code、Codex、Gemini などのリレーサービスを提供しています。PackyCode は当ソフトウェアのユーザーに特別割引を提供しています：<a href="https://www.packyapi.com/register?aff=ccx-kit">このリンク</a>から登録し、チャージ時に「zcf」プロモーションコードを入力すると 10% オフになります。</td>
</tr>
<tr>
...
ZCF（Zero-Config Code Flow）は、専門開発者向けの CLI ツールで、Claude Code と Codex のエンドツーエンド環境初期化を数分で完了することを目指しています。`npx ccx-kit` を通じて、設定ディレクトリの作成、API/プロキシ統合、MCP サービス統合、ワークフローインポート、出力スタイルとメモリ設定、および一般的なツールのインストールを一括で完了できます。
...
- **更新ログ**：[CHANGELOG.md](https://github.com/BenedictKing/ccx-kit/blob/main/CHANGELOG.md)
