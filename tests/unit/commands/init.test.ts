...
describe('init command', () => {
  beforeEach(async () => {
    ...
    const { updateAppConfig, readAppConfig } = await import('../../../src/utils/app-config')
    ...
    testMocks = {
      ...
      updateAppConfig: vi.mocked(updateAppConfig),
      readAppConfig: vi.mocked(readAppConfig),
  ...
  describe('init function', () => {
    describe('language selection', () => {
      it('should handle script language selection', async () => {
        ...
        testMocks.readAppConfig.mockReturnValue({ codeToolType: 'claude-code' } as any)
        ...
        testMocks.updateAppConfig.mockResolvedValue(undefined)
    ...
    it('should persist resolved code tool type to zcf config', async () => {
      ...
      expect(testMocks.updateAppConfig).toHaveBeenCalledWith(
    ...
    describe('integration flow', () => {
      it('should handle full initialization flow', async () => {
        ...
        testMocks.selectAndInstallWorkflows.mockResolvedValue(undefined)
        testMocks.configureOutputStyle.mockResolvedValue(undefined)
        testMocks.updateAppConfig.mockReturnValue(undefined)
        ...
        expect(testMocks.updateAppConfig).toHaveBeenCalled()
      }, 45000) // 45秒超时，给CI更多时间
    })
    ...
    describe('error handling', () => {
      it('should handle errors gracefully', async () => {
        ...
        testMocks.readAppConfig.mockImplementation(() => {
          throw error
        })
    ...
    describe('codex-specific initialization', () => {
      it('should display codex banner when codeType is codex', async () => {
        ...
        testMocks.readAppConfig.mockReturnValue({ codeToolType: 'codex' } as any)
        testMocks.existsSync.mockReturnValue(false)
