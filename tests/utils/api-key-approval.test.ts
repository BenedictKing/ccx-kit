...
describe('aPI Key Approval Management', () => {
  ...
  describe('edge Cases', () => {
    ...
    it('should truncate API key to 20 characters for storage', () => {
      ...
      const longApiKey = 'sk-ccx-kit-very-long-api-key-that-exceeds-20-characters'
      const expectedTruncated = longApiKey.substring(0, 20) // 'sk-ccx-kit-very-lo'
    ...
    it('should handle exactly 20 character API key without truncation', () => {
      ...
      const exactApiKey = 'sk-ccx-kit-exact20c'
