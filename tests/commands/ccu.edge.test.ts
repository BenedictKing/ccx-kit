...
describe('cCU Command - Edge Cases', () => {
  ...
  beforeEach(() => {
    ...
    // Default mock for appConfig
    vi.mocked(appConfig.readAppConfigAsync).mockResolvedValue({
      preferredLang: 'en',
    } as any)
  })
  ...
  describe('edge cases', () => {
    ...
    it('should handle appConfig read errors', async () => {
      // Config read fails, but we catch it and use default
      vi.mocked(appConfig.readAppConfigAsync)
    ...
    it('should handle undefined appConfig fields', async () => {
      vi.mocked(appConfig.readAppConfigAsync).mockResolvedValue({
    ...
    it('should handle race condition in error handling', async () => {
      ...
      vi.mocked(appConfig.readAppConfigAsync).mockImplementation(async () => {
        configCallCount++
