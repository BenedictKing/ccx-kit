...
describe('i18n Integrity Tests', () => {
  ...
  describe('nPM Package Integrity', () => {
    ...
    it('should verify CLI translations work with built package', async () => {
      ...
      if (!existsSync(join(projectRoot, 'bin/ccx-kit.mjs'))) {
      ...
      try {
        ...
        const zhOutput = execSync('node bin/ccx-kit.mjs --lang zh-CN --help', {
          encoding: 'utf8',
          cwd: projectRoot,
          stdio: 'pipe',
        ...
        const enOutput = execSync('node bin/ccx-kit.mjs --lang en --help', {
          encoding: 'utf8',
          cwd: projectRoot,
          stdio: 'pipe',
          timeout: 10000, // 10 second timeout
