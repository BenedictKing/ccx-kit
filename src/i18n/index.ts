    ...
    .init({
      ...
      backend: {
        loadPath: (() => {
          ...
          // currentDir will be something like: /path/to/node_modules/ccx-kit/dist/i18n
          // or in chunks: /path/to/node_modules/ccx-kit/dist/chunks
          const packageRoot = (() => {
            let dir = currentDir
          ...
          const possibleBasePaths = [
            ...
            join(packageRoot, 'dist/i18n/locales'), // NPM package: /node_modules/ccx-kit/dist/i18n/locales
