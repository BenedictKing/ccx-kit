...
# examples:
#   - /ccx-kit-pr                        # Create PR from current branch to main
#   - /ccx-kit-pr --base develop         # Create PR to develop branch
#   - /ccx-kit-pr --draft                # Create draft PR
#   - /ccx-kit-pr --title "Bug Fix"      # Custom PR title
---

# CCX-Kit PR - Create Pull Request from Current Branch
...
```bash
/ccx-kit-pr [--base <branch>] [--draft] [--title <title>]
```
...
while [[ $# -gt 0 ]]; do
  case $1 in
    ...
    *)
      ...
      echo "Usage: /ccx-kit-pr [--base <branch>] [--draft] [--title <title>]"
      echo "Examples:"
      echo "  /ccx-kit-pr                           # Create PR to main"
      echo "  /ccx-kit-pr --base develop            # Create PR to develop"
      echo "  /ccx-kit-pr --draft                   # Create draft PR"
      echo "  /ccx-kit-pr --title 'Bug Fix'         # Custom title"
      exit 1
      ;;
  esac
done
...
---
🤖 Generated with /ccx-kit-pr command
EOF
...
# Custom title
/ccx-kit-pr --title "Critical bug fix for authentication"
